...
function ensureStyles() {
  ...
  var css = [
    ...
    /* 徽标 */
    '.ios-badge{display:inline-block;padding:2px 8px;border-radius:var(--radius-full,9999px);font-size:var(--font-size-caption1);font-weight:var(--font-weight-medium)}',
